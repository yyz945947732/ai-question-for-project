...
${pkg.types ? 'The project uses TypeScript.' : 'The project does not use TypeScript.'}
The project already uses the following dependencies (but feel free to add more):
${Object.keys(pkg.dependencies).join(',')}.
Could you help me write the core code in the context of ${isCN(pkg.description) ? 'Chinese' : 'English'}?
...
export const readmeTmpl = (pkg, code) => `I want to write documentation for my project "${
  pkg.name
...
Could you help me write the README in ${isCN(pkg.description) ? 'Chinese' : 'English'}?
